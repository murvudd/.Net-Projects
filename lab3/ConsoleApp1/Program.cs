...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //}
            //var list1 = from e in employees join d in departments on e.DepartmentId // łączenie dwóch list w nową listę 
            //            equals d.DepartmentId select new { EN = e.EmployeeName, DN = d.Name };
            ...
            //           into empgroup orderby empgroup.Key select empgroup;
